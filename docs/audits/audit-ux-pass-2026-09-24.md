...
- t_8c729895 (dispatcher_wedge kanban_db shim => kanban_db_dispatch — bind spawnable helpers from hermes_cli.kanban_db_dispatch, regression test no silent narrowing, shutdown warnings gone) -> MERGED+PUSHED (88ca315 fix, eb0a10c merge) — final worker completion (deploy confirm) in progress.
- REMAINING RUNNING: none. All four follow-on cards now landed or done. t_8c729895 (run 764) closing out its completion call.
