...
_SPARKRUN_STATUS_SCRIPT = (
    ...
    "from sparkrun.api import status as sparkrun_status\n"
    ...
    "snapshot=sparkrun_status(hosts,ssh_kwargs=ssh_kwargs)\n"
    "r=classify_cluster_status(snapshot,cache_dir=str(config.cache_dir),host_list=hosts)\n"
